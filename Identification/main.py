...
def get_parser():
    ...
    p.add_argument('--outputType', '-ot',
                   ...
                   default='full',
                   type=str,
                   help='Output type can be selected from "full" or "clean" mode, in "full mode", you will get stat. results for each calculated site, while in "n" mode only sites meet the thershold selected are shown')
